...
import cn.com.lgh.datasource.note.impl.DynamicDataSourceAspect;
 ...
 */
@Configuration
@Import(value= {NoXaDataSourceConfig.class, DynamicDataSourceAspect.class})
@EnableConfigurationProperties(LDataSourceProperties.class)
@ConditionalOnClass({ DataSource.class, EmbeddedDatabaseType.class })
@AutoConfigureBefore(value={DataSourceAutoConfiguration.class, XADataSourceAutoConfiguration.class, JtaAutoConfiguration.class})
